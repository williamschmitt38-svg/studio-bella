...
const pixKey = 'studiobella@pix.com.br';

pixBtn.addEventListener('click', () => {
    copyText(pixKey).then(() => {
        showToast('Chave PIX copiada! Mencione o desconto no agendamento 💕');
    }).catch(() => {
...
if (wifiBtn && wifiModal) {
    ...
    if (wifiPhone) {
        wifiPhone.addEventListener('click', () => {
            window.open('https://api.whatsapp.com/send?phone=5531999999999', '_blank');
        });
    }
}
